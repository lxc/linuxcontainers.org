 ...
 * doc: PATCH の追加に伴う rest-api の修正 <!-- Fix rest-api for PATCH addition -->
 * doc: environment.md の表のスタイルの修正 <!-- Fix the table sytle of environment.md -->
 ...
 * lxd/db: int64 の扱いの修正 <!-- Fix int64 handling -->
 ...
 * lxd/network: openvswitch の検出 <!-- Detect openvswitch -->
 * lxd/network: networkIsInUse の修正 <!-- Fix networkIsInUse -->
 * lxd/network: isOnBridge の移動とリネーム <!-- Move and rename isOnBridge -->
 * shared: 型チェック関数のエクスポート <!-- Export type checking functions -->
